...
func MakeVM(opts ...Option) *jsonnet.VM {
	o := Opts{}
...
func EvaluateFile(jsonnetFile string, opts ...Option) (string, error) {
...
func Evaluate(path, data string, opts ...Option) (string, error) {
	o := Opts{}
	for _, option := range opts {
		option(&o)
	}
...
func evaluateSnippet(evalFunc evalFunc, path, data string, opts ...Option) (string, error) {
